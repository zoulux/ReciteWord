...
public class ClassSix extends Activity {
	...
	private void initTitle() {
		...
		// 设置标题文字
		titleText.setText(getString(R.string.class_six));
	}
	...
	public void addClickListener(){
		   play.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
			       Toast.makeText(ClassSix.this, "play", Toast.LENGTH_SHORT).show();
		   ...
		   next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				HandleClassSixWord handleClassSixWord = new HandleClassSixWord(++id);
				   ...
				   if (id>max) {
					   --id;
				   Toast.makeText(ClassSix.this,"最后一个单词",Toast.LENGTH_SHORT).show();
				}else{
				   word.setText(handleClassSixWord.getWord());
				   phoneticSymbols.setText(handleClassSixWord.getPhoneticSymbols());
				   meanning.setText(handleClassSixWord.getMeanning());
		   ...
		   before.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (id<=min) {
					++id;
					Toast.makeText(ClassSix.this,"第一个单词",Toast.LENGTH_SHORT).show();
				}else{
		   ...
		   back.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ClassSix.this,Main.class);
